...
export class JsonLanguageServerProvider implements LanguageServerProvider {
    ...
    if (this.isContainer) {
      ...
      throw new Error(
        'Language server installation in containers is not supported. ' +
          'The vscode-json-language-server should be pre-installed in the container image.'
      );
    }
